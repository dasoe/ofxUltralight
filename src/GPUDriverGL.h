...
#include <AppCore/GPUDriverImpl.h>
//#include <glad/glad.h>
...
namespace ultralight {
	...
	public:
		...
		virtual const char* name() override { return "GPUDriverGL"; }
	...
	protected:
		std::map<int, GLuint> texture_map; /*<ultra�� ���������� �����ϴ� texture_id, opengl�� ������ texture_id>*/
		...
		std::map<int, GLuint> frame_buffer_map; /*<ultra�� ���������� �����ϴ� render_buffer_id, opengl�� ������ frame_buffer_id>*/

		std::map<GLuint, GLuint> frame_texture_map; /*<frame_buffer_map�� �� frame_buffer_id, ������ rbuf_texture_id>*/
