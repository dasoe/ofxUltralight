...
namespace ultralight {
	...
	void GPUDriverGL::CreateRenderBuffer(uint32_t render_buffer_id,
		const RenderBuffer& buffer) { //frame_buffer�� �����ϰ�, ���� texture�� ����
		...
		CHECK_GL();
		frame_texture_map[frame_buffer_id] = rbuf_texture_id; //fbo��, ������ �ؽ�ó ����
	...
	*/
	...
	void GPUDriverGL::DrawGeometry(uint32_t geometry_id,
		...
		BindRenderBuffer(state.render_buffer_id); //frame buffer�� �׸���
		...
		glBindVertexArray(geometry.vao);	//�ؽ�ó uv ��ǥ�� vertex ��ǥ�� ����

		CHECK_GL();

		BindTexture(0, state.texture_1_id); //�ؽ�ó ���� UpdateTexture imshow ���� ��
